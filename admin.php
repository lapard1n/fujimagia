    ...
    <main class="main">
        <div class="admin">
            ...
            <section class="admin-links">
                <div class="admin-links__btns">
                    <div class="btn-case">
                        <div class="admin-links__img">
            ...
            <div class="admin-case">
                <!-- PROGUCT CATALOG SECTION -->
                <section class="catalog catalog_disable">
                    <div class="cart__row new">
                        <div class="cart__product">Товар</div>
                        <div class="cart__quantity">Категория</div>
                        <div class="cart__sum">Цена</div>
                        <div class="cart__cancel"><div class="dat"></div></div>
                    </div>
                    <div class="order new">
                        <div class="order-row new">
                            <div class="order__product new">
                                <div class="order__img new">
                                    <img src="img/main/cards/01.webp">
                                </div>
                                <div class="order__info new">
                                    <h1>Это суши - суши</h1>
                                    <h1>200 г</h1>
                                </div>
                            </div>
                            ...
                            <div class="order__sum">99 Р</div>
                            <button class="order__сancel"><i class="fas fa-times"></i></button>
                            <button class="ghost-order-button"><i class="fas fa-arrow-circle-down"></i></button>
                            <div class="ghost-order-row">
                                <form action="">
                                    <input class="admin-input" type="file" value="изображение">
                                    <input class="admin-input" type="text" placeholder="наименование">
                                    <input class="admin-input" type="text" placeholder="граммовка">
                                    <select class="admin-input">
                                        <option>Классические роллы</option>
                                        <option>Запеченые роллы</option>
                                        <option>Мини роллы</option>
                                    </select>
                                    <input class="admin-input" type="text" placeholder="цена">
                                </form>
                            </div>
                        </div>
                    </div>
                ...
                <section class="history history_disable">
                    <div class="cart__sec">
                        ...
                        <div class="cart__client-sec">Клиент</div>
                    ...
                    <div class="order-sec">
                        <div class="order-row-sec">
                            ...
                            <div class="order__client-sec">JoJo</div>
