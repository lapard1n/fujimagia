...
class Customer
{
    ...
    function setUpdatedBy($updatedBy) { $this->updatedBy = $updatedBy; return $this;}
    function getUpdatedBy() { return $this->updatedBy; }
    function setUpdatedOn($updatedOn) { $this->updatedOn = $updatedOn; return $this;}
    function getUpdatedOn() { return $this->updatedOn; }
    function setCreatedBy($createdBy) { $this->createdBy = $createdBy; return $this;}
    function getCreatedBy() { return $this->createdBy; }
    function setCreatedOn($createdOn) { $this->createdOn = $createdOn; return $this;}
